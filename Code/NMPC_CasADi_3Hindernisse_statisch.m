...
fprintf('\n===== Zeitmessung: 3 statische Hindernisse =====\n');
...
disp(runtime_table);
writetable(runtime_table, 'runtime_3_statische_Hindernisse.csv');
save('runtime_3_statische_Hindernisse.mat', 'runtime_table', 'solver_time', 'step_time');
